...
<?php
	...
	$query = "SELECT * FROM `bbqfirst_db`.`regionaldata` ORDER BY `regionaldata`.`sauce` DESC, `teams` DESC";
	$que = "SELECT * FROM `bbqfirst_db`.`regionaldata` ORDER BY `regionaldata`.`sauce` DESC, `teams` DESC LIMIT 25";
