...
<?php
	...
	$query = "SELECT * FROM `bbqfirst_db`.`regionaldata` WHERE `year`='$year' ORDER BY `regionaldata`.`sauce` DESC, `teams` DESC";
	$que = "SELECT * FROM `bbqfirst_db`.`regionaldata` WHERE `year`='$year' ORDER BY `regionaldata`.`sauce` DESC, `teams` DESC LIMIT 25";
